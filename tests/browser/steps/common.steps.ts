...
Given(
  ...
  function openWorkspace(this: StepContext) {
...
Given(
  ...
  function openFxWorkspace(this: StepContext) {
...
Given(
  ...
  function openCreditWorkspace(this: StepContext) {
...
When(
  ...
  function clickTab(this: StepContext, tab: string) {
    return common.clickTab(this.ctx, tab);
  },
);

When("the trader reloads the page", function reloadPage(this: StepContext) {
