...
When("the trader toggles the theme", function (this: StepContext) {
  return theme.toggleAndCaptureBackgrounds(this.ctx);
});

Then("the theme toggle button is visible", function (this: StepContext) {
...
Then("a price tile is visible", function (this: StepContext) {
  return theme.expectFirstPriceTileVisible(this.ctx, 5_000);
});

Then("the credit navigation is visible", function (this: StepContext) {
