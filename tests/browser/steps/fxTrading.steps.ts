...
When("the trader clicks buy on the first tile", function (this: StepContext) {
  return fxTrading.clickBuyOnFirstTile(this.ctx);
});

When("the trader clicks sell on the first tile", function (this: StepContext) {
...
Then("the blotter table is visible", function (this: StepContext) {
...
Then("at least one trade was rejected", function (this: StepContext) {
