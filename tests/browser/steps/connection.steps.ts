...
When(
  ...
  function browserGoesOffline(this: StepContext) {
...
When(
  ...
  function browserComesBackOnline(this: StepContext) {
...
Then(
  ...
  function expectConnectionStatusFooterVisible(this: StepContext) {
...
Then(
  ...
  function expectConnectionStatusFooterShows(
    this: StepContext,
    expected: string,
  ) {
...
Then(
  ...
  function expectConnectionOverlayHidden(this: StepContext) {
...
Then(
  ...
  function expectConnectionOverlayVisibleWithin(
    this: StepContext,
    seconds: number,
  ) {
...
Then(
  ...
  function expectConnectionOverlayHiddenWithin(
    this: StepContext,
    seconds: number,
  ) {
...
Then(
  ...
  function expectConnectionOverlayTextMatches(this: StepContext, raw: string) {
