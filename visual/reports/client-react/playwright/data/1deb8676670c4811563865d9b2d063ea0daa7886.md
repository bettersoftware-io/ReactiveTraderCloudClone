...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-dark/credit-rfqs-card-passed.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/credit-rfqs-card-passed.png)" getByTestId('scenario-root') with timeout 5000ms
...
- generic [ref=e5]:
  - generic [ref=e6]:
    - generic [ref=e7]:
      - generic [ref=e8]:
        - generic [ref=e9]: BUY
        - generic [ref=e10]: T 1.5 02/34
      - generic [ref=e11]: 912828ZQ6 · QTY 4,000,000
    - generic [ref=e12]: LIVE
  - generic [ref=e14]:
    - generic [ref=e15]: Citi
