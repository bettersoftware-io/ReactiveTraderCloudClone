...
Locator: getByTestId('scenario-root')
  31643 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-line.png)" with timeout 5000ms
