...
- Name: visual.spec.ts >> equities/chart-indicators__holo3d-dark
...
Locator: getByTestId('scenario-root')
  36706 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-indicators.png)" with timeout 5000ms
