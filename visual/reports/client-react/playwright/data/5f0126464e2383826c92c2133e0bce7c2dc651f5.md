...
- Name: visual.spec.ts >> equities/chart-history-start__terminal3d-light
- Location: tests/ui/visual/playwright/visual.spec.ts:9:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/terminal3d-light/equities-chart-history-start.png, writing actual.
```
...
- generic [ref=e5]:
  - application "Price chart" [ref=e6]:
    - generic [ref=e11]: "152.68"
    - generic [ref=e12]: "137.43"
    - generic [ref=e13]: "122.18"
    - generic [ref=e14]: "106.93"
    - img [ref=e135]
