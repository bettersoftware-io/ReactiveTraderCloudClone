...
- Name: visual.spec.ts >> equities/chart-area__terminal3d-dark
- Location: tests/ui/visual/playwright/visual.spec.ts:9:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/terminal3d-dark/equities-chart-area.png, writing actual.
```
...
- generic [ref=e5]:
  - application "Price chart" [ref=e6]:
    ...
    - img [ref=e15]
  - generic [ref=e79]:
    - generic [ref=e80]: 04:00
    - generic [ref=e81]: 04:15
    - generic [ref=e82]: 04:30
    - generic [ref=e83]: 04:45
```
