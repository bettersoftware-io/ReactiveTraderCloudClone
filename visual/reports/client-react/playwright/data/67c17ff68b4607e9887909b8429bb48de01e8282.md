...
- Name: visual.spec.ts >> equities/chart-log-scale__holo3d-light
- Location: tests/ui/visual/playwright/visual.spec.ts:9:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/holo3d-light/equities-chart-log-scale.png, writing actual.
```
