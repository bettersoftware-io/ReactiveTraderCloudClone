...
Locator: getByTestId('scenario-root')
  29792 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-area.png)" with timeout 5000ms
