...
Locator: getByTestId('scenario-root')
  45548 pixels (ratio 0.13 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-zoomed.png)" with timeout 5000ms
