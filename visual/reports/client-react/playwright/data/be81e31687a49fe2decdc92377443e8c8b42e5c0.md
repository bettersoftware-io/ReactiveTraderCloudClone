...
- Name: visual.spec.ts >> equities/chart-indicators__terminal-light
...
Locator: getByTestId('scenario-root')
  34543 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-indicators.png)" with timeout 5000ms
