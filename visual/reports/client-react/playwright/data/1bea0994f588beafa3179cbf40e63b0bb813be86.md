...
Locator: getByTestId('scenario-root')
  29710 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal-dark/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-area.png)" with timeout 5000ms
