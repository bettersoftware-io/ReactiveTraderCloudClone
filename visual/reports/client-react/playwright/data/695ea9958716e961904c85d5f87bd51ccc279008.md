...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-light/equities-chart-history-start.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-history-start.png)" with timeout 5000ms
