...
- Name: visual.spec.ts >> equities/chart-panel__holo-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo-light/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-panel.png)" with timeout 5000ms
