...
Locator: getByTestId('scenario-root')
  34661 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-volume-axis.png)" with timeout 5000ms
