...
- Name: visual.spec.ts >> equities/chart-crosshair__terminal-light
...
Locator: getByTestId('scenario-root')
  35064 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-crosshair.png)" with timeout 5000ms
