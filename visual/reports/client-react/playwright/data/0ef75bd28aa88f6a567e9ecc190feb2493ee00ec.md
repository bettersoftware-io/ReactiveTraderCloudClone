...
```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/holo3d-light/equities-chart-crosshair.png, writing actual.
```
