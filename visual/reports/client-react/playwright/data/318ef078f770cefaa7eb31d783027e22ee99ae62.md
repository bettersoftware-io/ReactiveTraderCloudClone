...
- Name: visual.spec.ts >> credit/rfqs-card-passed__terminal-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal-light/credit-rfqs-card-passed.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/credit-rfqs-card-passed.png)" getByTestId('scenario-root') with timeout 5000ms
