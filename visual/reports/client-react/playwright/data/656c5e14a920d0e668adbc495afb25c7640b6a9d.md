...
- Name: visual.spec.ts >> equities/chart-indicators__terminal3d-light
...
Locator: getByTestId('scenario-root')
  34518 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-indicators.png)" with timeout 5000ms
