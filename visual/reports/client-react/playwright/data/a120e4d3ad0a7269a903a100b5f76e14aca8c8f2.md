...
Locator: getByTestId('scenario-root')
  29555 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-line.png)" with timeout 5000ms
