...
- Name: visual.spec.ts >> equities/chart-crosshair__terminal3d-light
...
Locator: getByTestId('scenario-root')
  35036 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-crosshair.png)" with timeout 5000ms
