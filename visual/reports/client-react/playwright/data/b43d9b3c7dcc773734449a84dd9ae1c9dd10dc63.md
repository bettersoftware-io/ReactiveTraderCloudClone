...
- Name: visual.spec.ts >> equities/chart-volume-axis__holo3d-light
...
Locator: getByTestId('scenario-root')
  33958 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: holo3d-light/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-volume-axis.png)" with timeout 5000ms
