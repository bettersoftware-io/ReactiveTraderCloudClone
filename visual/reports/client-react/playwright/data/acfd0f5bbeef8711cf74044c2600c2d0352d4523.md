...
Locator: getByTestId('scenario-root')
  30793 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-area.png)" with timeout 5000ms
