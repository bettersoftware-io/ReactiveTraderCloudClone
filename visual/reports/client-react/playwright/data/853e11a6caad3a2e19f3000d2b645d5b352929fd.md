...
- Name: visual.spec.ts >> equities/chart-log-scale__terminal3d-light
- Location: tests/ui/visual/playwright/visual.spec.ts:9:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/terminal3d-light/equities-chart-log-scale.png, writing actual.
```
...
- generic [ref=e5]:
  - application "Price chart" [ref=e6]:
    - generic [ref=e11]: "392.14"
    - generic [ref=e12]: "376.25"
    - generic [ref=e13]: "361.00"
    - generic [ref=e14]: "346.37"
    - img [ref=e135]
  - generic [ref=e197]:
