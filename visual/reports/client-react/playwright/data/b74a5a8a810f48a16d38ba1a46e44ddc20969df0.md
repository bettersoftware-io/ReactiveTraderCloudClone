...
- Name: visual.spec.ts >> equities/chart-panel__holo3d-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo3d-dark/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-panel.png)" with timeout 5000ms
