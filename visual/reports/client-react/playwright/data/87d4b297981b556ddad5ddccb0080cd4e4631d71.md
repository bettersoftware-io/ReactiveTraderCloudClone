...
Locator: getByTestId('scenario-root')
  29732 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-area.png)" with timeout 5000ms
