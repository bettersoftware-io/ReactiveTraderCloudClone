...
Locator: getByTestId('scenario-root')
  35254 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal-dark/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-panned.png)" with timeout 5000ms
