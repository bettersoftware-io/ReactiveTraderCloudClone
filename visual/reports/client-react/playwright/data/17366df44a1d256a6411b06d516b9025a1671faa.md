...
Locator: getByTestId('scenario-root')
  42880 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-zoomed.png)" with timeout 5000ms
