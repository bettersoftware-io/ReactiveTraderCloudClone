...
Locator: getByTestId('scenario-root')
  29197 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-line.png)" with timeout 5000ms
