...
- Name: visual.spec.ts >> equities/chart-volume-axis__terminal-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal-dark/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-volume-axis.png)" with timeout 5000ms
