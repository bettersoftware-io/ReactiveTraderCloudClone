...
- Name: visual.spec.ts >> equities/chart-crosshair__classic-light
...
Locator: getByTestId('scenario-root')
  34794 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-crosshair.png)" with timeout 5000ms
