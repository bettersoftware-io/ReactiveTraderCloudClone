...
- Name: visual.spec.ts >> equities/chart-panel__terminal3d-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-dark/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-panel.png)" with timeout 5000ms
