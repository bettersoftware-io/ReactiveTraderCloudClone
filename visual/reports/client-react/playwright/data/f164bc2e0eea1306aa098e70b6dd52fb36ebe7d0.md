...
Locator: getByTestId('scenario-root')
  35056 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-panned.png)" with timeout 5000ms
