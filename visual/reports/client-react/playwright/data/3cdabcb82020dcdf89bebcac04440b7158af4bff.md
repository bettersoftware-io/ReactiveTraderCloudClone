...
- Name: visual.spec.ts >> equities/chart-canvas__terminal-light
...
Locator: getByTestId('scenario-root')
  5707 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-canvas.png)" with timeout 5000ms
