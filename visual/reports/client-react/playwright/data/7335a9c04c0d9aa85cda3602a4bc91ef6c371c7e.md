...
Locator: getByTestId('scenario-root')
  28407 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-line.png)" with timeout 5000ms
