...
Locator: getByTestId('scenario-root')
  29122 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-area.png)" with timeout 5000ms
