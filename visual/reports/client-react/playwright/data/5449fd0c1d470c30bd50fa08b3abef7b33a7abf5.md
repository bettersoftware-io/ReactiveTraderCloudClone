...
- Name: visual.spec.ts >> equities/chart-volume-axis__classic-light
...
Locator: getByTestId('scenario-root')
  33351 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-volume-axis.png)" with timeout 5000ms
