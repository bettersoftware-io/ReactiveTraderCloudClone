...
Locator: getByTestId('scenario-root')
  43242 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: holo3d-light/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-zoomed.png)" with timeout 5000ms
