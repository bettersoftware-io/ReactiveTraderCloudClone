...
- Name: visual.spec.ts >> equities/chart-indicators__terminal-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal-dark/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-indicators.png)" with timeout 5000ms
