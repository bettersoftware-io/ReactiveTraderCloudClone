...
- Name: visual.spec.ts >> credit/rfqs-card-rejected__terminal3d-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-dark/credit-rfqs-card-rejected.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/credit-rfqs-card-rejected.png)" getByTestId('scenario-root') with timeout 5000ms
