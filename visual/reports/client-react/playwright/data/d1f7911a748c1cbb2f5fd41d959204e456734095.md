...
- Name: visual.spec.ts >> equities/chart-history-start__holo-light
- Location: tests/ui/visual/playwright/visual.spec.ts:9:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/holo-light/equities-chart-history-start.png, writing actual.
```
