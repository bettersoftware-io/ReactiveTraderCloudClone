...
Locator: getByTestId('scenario-root')
  29839 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: holo3d-light/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-area.png)" with timeout 5000ms
