...
Locator: getByTestId('scenario-root')
  33476 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-indicators.png)" with timeout 5000ms
