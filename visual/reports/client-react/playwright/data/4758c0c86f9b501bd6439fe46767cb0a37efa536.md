...
Locator: getByTestId('scenario-root')
  5831 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-canvas.png)" with timeout 5000ms
