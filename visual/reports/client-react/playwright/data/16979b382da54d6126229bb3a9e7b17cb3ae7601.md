...
Locator: getByTestId('scenario-root')
  34731 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-crosshair.png)" with timeout 5000ms
