...
Locator: getByTestId('scenario-root')
  5721 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-canvas.png)" with timeout 5000ms
