...
- Name: visual.spec.ts >> equities/chart-volume-axis__holo3d-dark
...
Locator: getByTestId('scenario-root')
  35763 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-volume-axis.png)" with timeout 5000ms
