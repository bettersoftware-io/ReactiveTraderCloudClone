...
Locator: getByTestId('scenario-root')
  35994 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-panned.png)" with timeout 5000ms
