...
- Name: visual.spec.ts >> app/admin__terminal3d-light
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  405360 pixels (ratio 0.20 of all image pixels) are different.

  Snapshot: terminal3d-light/app-admin.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/app-admin.png)" with timeout 5000ms
