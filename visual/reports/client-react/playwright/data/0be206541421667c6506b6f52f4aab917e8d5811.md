...
- Name: visual.spec.ts >> equities/chart-panel__classic-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: classic-dark/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(classic-dark/equities-chart-panel.png)" with timeout 5000ms
