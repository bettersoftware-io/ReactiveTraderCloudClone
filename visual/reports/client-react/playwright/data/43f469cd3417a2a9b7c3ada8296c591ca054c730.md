...
Locator: getByTestId('scenario-root')
  29451 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-area.png)" with timeout 5000ms
