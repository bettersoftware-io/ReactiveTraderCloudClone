...
- Name: visual.spec.ts >> equities/chart-panel__classic-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: classic-light/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-panel.png)" with timeout 5000ms
