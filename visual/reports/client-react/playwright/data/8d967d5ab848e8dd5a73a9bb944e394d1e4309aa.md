...
Locator: getByTestId('scenario-root')
  43287 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-zoomed.png)" with timeout 5000ms
