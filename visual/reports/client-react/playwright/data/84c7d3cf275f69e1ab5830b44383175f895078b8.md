...
Locator: getByTestId('scenario-root')
  37546 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-panned.png)" with timeout 5000ms
