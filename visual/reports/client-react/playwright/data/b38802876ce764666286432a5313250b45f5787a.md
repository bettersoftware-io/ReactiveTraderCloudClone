...
Locator: getByTestId('scenario-root')
  31244 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-area.png)" with timeout 5000ms
