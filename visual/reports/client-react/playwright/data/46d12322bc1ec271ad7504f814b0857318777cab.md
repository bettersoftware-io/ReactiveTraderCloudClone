...
Locator: getByTestId('scenario-root')
  31563 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: classic-dark/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(classic-dark/equities-chart-zoomed.png)" with timeout 5000ms
