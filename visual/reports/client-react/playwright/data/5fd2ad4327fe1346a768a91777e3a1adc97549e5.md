...
- Name: visual.spec.ts >> equities/chart-pane-rsi__terminal3d-light
- Location: tests/ui/visual/playwright/visual.spec.ts:9:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/terminal3d-light/equities-chart-pane-rsi.png, writing actual.
```
...
- generic [ref=e5]:
  ...
  - generic [ref=e197]:
    ...
    - img
  - generic [ref=e198]:
    - generic [ref=e199]: 04:00
    - generic [ref=e200]: 04:15
    - generic [ref=e201]: 04:30
    - generic [ref=e202]: 04:45
