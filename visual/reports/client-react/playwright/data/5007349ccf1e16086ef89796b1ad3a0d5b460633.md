...
- Name: visual.spec.ts >> equities/chart-panel__holo3d-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo3d-light/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-panel.png)" with timeout 5000ms
