...
Locator: getByTestId('scenario-root')
  5874 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-canvas.png)" with timeout 5000ms
