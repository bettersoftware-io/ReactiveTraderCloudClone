...
- Name: visual.spec.ts >> app/equities-dockview__classic-light
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1761 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: classic-light/app-equities-dockview.png

Call log:
  - Expect "toHaveScreenshot(classic-light/app-equities-dockview.png)" with timeout 5000ms
