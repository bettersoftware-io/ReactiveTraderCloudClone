...
Locator: getByTestId('scenario-root')
  29248 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-line.png)" with timeout 5000ms
