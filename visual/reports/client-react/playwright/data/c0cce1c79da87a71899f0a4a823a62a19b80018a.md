...
Locator: getByTestId('scenario-root')
  5747 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: holo3d-light/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-canvas.png)" with timeout 5000ms
