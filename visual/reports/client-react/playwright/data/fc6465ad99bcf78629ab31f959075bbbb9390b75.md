...
- Name: visual.spec.ts >> equities/chart-indicators__classic-light
...
Locator: getByTestId('scenario-root')
  34181 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-indicators.png)" with timeout 5000ms
