...
- Name: visual.spec.ts >> shell/layout-dockview__classic-dark
...
Locator: getByTestId('scenario-root')
  707 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: classic-dark/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(classic-dark/shell-layout-dockview.png)" with timeout 5000ms
