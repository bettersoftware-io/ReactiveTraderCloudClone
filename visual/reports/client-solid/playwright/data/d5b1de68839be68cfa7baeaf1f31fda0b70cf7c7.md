...
- Name: visual.spec.ts >> equities/chart-loading-older__classic-dark
- Location: tests/ui/visual/playwright/visual.spec.ts:17:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/classic-dark/equities-chart-loading-older.png.
```
...
- generic [ref=e5]:
  - application "Price chart" [ref=e6]:
    ...
    - img [ref=e135]
    - generic: LOADING OLDER…
  - generic [ref=e197]:
    - generic [ref=e198]: 04:00
    - generic [ref=e199]: 04:15
    - generic [ref=e200]: 04:30
    - generic [ref=e201]: 04:45
  - group "Chart navigator" [ref=e202]:
    - img [ref=e203]
```
