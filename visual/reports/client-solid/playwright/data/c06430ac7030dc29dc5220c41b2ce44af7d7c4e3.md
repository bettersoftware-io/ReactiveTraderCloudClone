...
Locator: getByTestId('scenario-root')
  30534 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-line.png)" with timeout 5000ms
