...
- Name: visual.spec.ts >> shell/layout-dockview__terminal-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal-dark/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/shell-layout-dockview.png)" with timeout 5000ms
