...
- Name: visual.spec.ts >> app/admin__terminal-dark
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: terminal-dark/app-admin.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/app-admin.png)" with timeout 5000ms
