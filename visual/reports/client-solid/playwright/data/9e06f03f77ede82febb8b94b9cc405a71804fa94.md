...
Locator: getByTestId('scenario-root')
  33702 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-volume-axis.png)" with timeout 5000ms
