...
- Name: visual.spec.ts >> shell/layout-dockview__holo-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo-light/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(holo-light/shell-layout-dockview.png)" with timeout 5000ms
