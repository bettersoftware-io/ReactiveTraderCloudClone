...
- Name: visual.spec.ts >> equities/chart-loading-older__terminal-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal-light/equities-chart-loading-older.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-loading-older.png)" with timeout 5000ms
