...
- Name: visual.spec.ts >> equities/chart-indicators__classic-dark
...
Locator: getByTestId('scenario-root')
  23576 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: classic-dark/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(classic-dark/equities-chart-indicators.png)" with timeout 5000ms
