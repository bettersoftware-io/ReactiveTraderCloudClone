...
- Name: visual.spec.ts >> tile/rfq-received__holo3d-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo3d-light/tile-rfq-received.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/tile-rfq-received.png)" getByTestId('scenario-root') with timeout 5000ms
