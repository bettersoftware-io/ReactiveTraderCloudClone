...
- Name: visual.spec.ts >> equities/chart-drawings__terminal3d-dark
- Location: tests/ui/visual/playwright/visual.spec.ts:17:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/terminal3d-dark/equities-chart-drawings.png.
```
...
- generic [ref=e5]:
  - application "Price chart" [ref=e6]:
    - generic [ref=e11]: "400.00"
    - generic [ref=e12]: "380.00"
    - generic [ref=e13]: "360.00"
    - generic [ref=e14]: "340.00"
    - img [ref=e135]
    - img
  - generic [ref=e197]:
