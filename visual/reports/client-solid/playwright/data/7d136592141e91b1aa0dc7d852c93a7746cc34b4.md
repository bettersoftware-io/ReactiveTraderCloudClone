...
Locator: getByTestId('scenario-root')
  43501 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: terminal-dark/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-zoomed.png)" with timeout 5000ms
