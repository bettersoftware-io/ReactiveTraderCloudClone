...
Locator: getByTestId('scenario-root')
  36053 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-crosshair.png)" with timeout 5000ms
