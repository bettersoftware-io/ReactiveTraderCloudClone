...
- Name: visual.spec.ts >> equities/chart-volume-axis__terminal3d-dark
...
Locator: getByTestId('scenario-root')
  32546 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-volume-axis.png)" with timeout 5000ms
