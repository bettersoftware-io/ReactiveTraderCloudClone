...
- Name: visual.spec.ts >> equities/chart-crosshair__holo3d-dark
...
Locator: getByTestId('scenario-root')
  37138 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo3d-dark/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/equities-chart-crosshair.png)" with timeout 5000ms
