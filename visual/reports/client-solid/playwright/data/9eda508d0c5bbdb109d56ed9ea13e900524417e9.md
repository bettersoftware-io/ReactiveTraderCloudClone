...
- Name: visual.spec.ts >> shell/layout-dockview__terminal3d-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-dark/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/shell-layout-dockview.png)" with timeout 5000ms
