...
Locator: getByTestId('scenario-root')
  35660 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo3d-light/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-panned.png)" with timeout 5000ms
