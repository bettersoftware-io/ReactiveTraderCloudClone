...
- Name: visual.spec.ts >> equities/chart-crosshair__holo3d-light
...
Locator: getByTestId('scenario-root')
  35318 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo3d-light/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-crosshair.png)" with timeout 5000ms
