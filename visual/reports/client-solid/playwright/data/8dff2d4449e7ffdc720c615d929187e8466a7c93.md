...
- Name: visual.spec.ts >> equities/chart-crosshair__terminal-dark
...
Locator: getByTestId('scenario-root')
  32888 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: terminal-dark/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-crosshair.png)" with timeout 5000ms
