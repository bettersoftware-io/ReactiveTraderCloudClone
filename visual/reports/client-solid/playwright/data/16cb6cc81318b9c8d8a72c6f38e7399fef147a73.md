...
- Name: visual.spec.ts >> equities/chart-panned__terminal3d-light
...
Locator: getByTestId('scenario-root')
  35964 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-panned.png)" with timeout 5000ms
