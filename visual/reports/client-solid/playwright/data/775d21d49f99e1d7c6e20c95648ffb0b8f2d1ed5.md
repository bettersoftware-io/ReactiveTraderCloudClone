...
- Name: visual.spec.ts >> equities/chart-panel__holo-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo-dark/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-panel.png)" with timeout 5000ms
