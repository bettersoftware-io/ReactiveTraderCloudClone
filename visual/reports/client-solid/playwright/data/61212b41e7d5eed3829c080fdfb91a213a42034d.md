...
- Name: visual.spec.ts >> credit/rfqs-card-rejected__terminal3d-light
...
Locator: getByTestId('scenario-root')
  671 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: terminal3d-light/credit-rfqs-card-rejected.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/credit-rfqs-card-rejected.png)" getByTestId('scenario-root') with timeout 5000ms
...
- generic [ref=e5]:
  - generic [ref=e6]:
    - generic [ref=e7]:
      - generic [ref=e8]:
        - generic [ref=e9]: SELL
        - generic [ref=e10]: AAPL 2.4 30
      - generic [ref=e11]: 037833EK8 · QTY 1,500,000
    - generic [ref=e12]: LIVE
  - generic [ref=e14]:
    - generic [ref=e15]: JP Morgan
    - generic [ref=e17]: Rejected
  - generic [ref=e20]:
    - generic [ref=e21]: 120 secs
