...
Locator: getByTestId('scenario-root')
  36481 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-panned.png)" with timeout 5000ms
