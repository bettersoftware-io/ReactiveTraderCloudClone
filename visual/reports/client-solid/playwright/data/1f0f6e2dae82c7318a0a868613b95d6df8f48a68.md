...
Locator: getByTestId('scenario-root')
  29525 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-line.png)" with timeout 5000ms
