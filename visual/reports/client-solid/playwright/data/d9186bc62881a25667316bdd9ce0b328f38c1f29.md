...
Locator: getByTestId('scenario-root')
  5829 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-canvas.png)" with timeout 5000ms
