...
Locator: getByTestId('scenario-root')
  33370 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-volume-axis.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-volume-axis.png)" with timeout 5000ms
