...
- Name: visual.spec.ts >> app/admin__holo-light
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  411889 pixels (ratio 0.20 of all image pixels) are different.

  Snapshot: holo-light/app-admin.png

Call log:
  - Expect "toHaveScreenshot(holo-light/app-admin.png)" with timeout 5000ms
