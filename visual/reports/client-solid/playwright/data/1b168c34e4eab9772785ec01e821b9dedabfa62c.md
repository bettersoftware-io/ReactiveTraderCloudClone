...
Locator: getByTestId('scenario-root')
  35200 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-panned.png)" with timeout 5000ms
