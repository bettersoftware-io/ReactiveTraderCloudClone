...
Locator: getByTestId('scenario-root')
  5756 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: classic-dark/equities-chart-canvas.png

Call log:
  - Expect "toHaveScreenshot(classic-dark/equities-chart-canvas.png)" with timeout 5000ms
