...
Locator: getByTestId('scenario-root')
  7185 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: classic-light/equities-chart-canvas-spike.png

Call log:
  - Expect "toHaveScreenshot(classic-light/equities-chart-canvas-spike.png)" with timeout 5000ms
