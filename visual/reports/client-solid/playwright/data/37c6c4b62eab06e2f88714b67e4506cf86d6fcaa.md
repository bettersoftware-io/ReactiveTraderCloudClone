...
- Name: visual.spec.ts >> equities/chart-panel__terminal-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal-light/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-panel.png)" with timeout 5000ms
