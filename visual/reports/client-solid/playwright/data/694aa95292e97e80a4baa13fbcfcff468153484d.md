...
- Name: visual.spec.ts >> credit/rfqs-card-passed__classic-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: classic-light/credit-rfqs-card-passed.png

Call log:
  - Expect "toHaveScreenshot(classic-light/credit-rfqs-card-passed.png)" getByTestId('scenario-root') with timeout 5000ms
