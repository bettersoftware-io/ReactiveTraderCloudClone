...
- Name: visual.spec.ts >> shell/layout-dockview__holo3d-dark
...
Locator: getByTestId('scenario-root')
  2388 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: holo3d-dark/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(holo3d-dark/shell-layout-dockview.png)" with timeout 5000ms
