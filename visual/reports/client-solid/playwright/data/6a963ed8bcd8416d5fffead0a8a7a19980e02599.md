...
Locator: getByTestId('scenario-root')
  35593 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-indicators.png)" with timeout 5000ms
