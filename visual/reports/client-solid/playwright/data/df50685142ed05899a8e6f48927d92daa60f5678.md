...
- Name: visual.spec.ts >> shell/layout-dockview__terminal-light
...
Locator: getByTestId('scenario-root')
  877 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: terminal-light/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/shell-layout-dockview.png)" with timeout 5000ms
