...
- Name: visual.spec.ts >> app/admin__terminal3d-dark
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: terminal3d-dark/app-admin.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/app-admin.png)" with timeout 5000ms
