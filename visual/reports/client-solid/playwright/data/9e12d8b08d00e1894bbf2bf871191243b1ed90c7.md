...
Locator: getByTestId('scenario-root')
  25071 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: classic-dark/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(classic-dark/equities-chart-panned.png)" with timeout 5000ms
