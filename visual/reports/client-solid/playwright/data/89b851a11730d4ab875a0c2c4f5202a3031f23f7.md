...
- Name: visual.spec.ts >> shell/layout-dockview__terminal3d-light
...
Locator: getByTestId('scenario-root')
  1342 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: terminal3d-light/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/shell-layout-dockview.png)" with timeout 5000ms
