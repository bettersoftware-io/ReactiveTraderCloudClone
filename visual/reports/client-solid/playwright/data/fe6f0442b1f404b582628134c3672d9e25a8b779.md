...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-light/equities-chart-panel.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-panel.png)" with timeout 5000ms
...
- generic [ref=e6]:
  ...
  - generic [ref=e27]:
    - application "Price chart" [ref=e28]:
      - generic [ref=e33]: "180.00"
      - generic [ref=e34]: "175.00"
      - generic [ref=e35]: "170.00"
      - generic [ref=e36]: "165.00"
      - img [ref=e117]
    - generic [ref=e159]:
