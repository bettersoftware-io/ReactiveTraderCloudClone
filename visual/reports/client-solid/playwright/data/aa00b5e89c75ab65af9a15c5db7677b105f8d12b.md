...
Locator: getByTestId('scenario-root')
  44376 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: holo-dark/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(holo-dark/equities-chart-zoomed.png)" with timeout 5000ms
