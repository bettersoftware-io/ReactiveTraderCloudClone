...
- Name: visual.spec.ts >> equities/chart-zoomed__terminal3d-light
...
Locator: getByTestId('scenario-root')
  43780 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-zoomed.png)" with timeout 5000ms
