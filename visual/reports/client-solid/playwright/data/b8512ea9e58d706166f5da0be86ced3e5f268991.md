...
- Name: visual.spec.ts >> equities/chart-indicators__holo3d-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo3d-light/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/equities-chart-indicators.png)" with timeout 5000ms
