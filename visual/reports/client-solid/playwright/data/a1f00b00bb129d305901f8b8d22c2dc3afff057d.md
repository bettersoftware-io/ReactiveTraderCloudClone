...
- Name: visual.spec.ts >> app/admin__terminal-light
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  448843 pixels (ratio 0.22 of all image pixels) are different.

  Snapshot: terminal-light/app-admin.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/app-admin.png)" with timeout 5000ms
