...
- Name: visual.spec.ts >> equities/chart-crosshair__terminal3d-dark
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: terminal3d-dark/equities-chart-crosshair.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-crosshair.png)" with timeout 5000ms
