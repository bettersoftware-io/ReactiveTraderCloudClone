...
- Name: visual.spec.ts >> shell/layout-dockview__holo3d-light
...
Locator: getByTestId('scenario-root')
  ...
  Snapshot: holo3d-light/shell-layout-dockview.png

Call log:
  - Expect "toHaveScreenshot(holo3d-light/shell-layout-dockview.png)" with timeout 5000ms
