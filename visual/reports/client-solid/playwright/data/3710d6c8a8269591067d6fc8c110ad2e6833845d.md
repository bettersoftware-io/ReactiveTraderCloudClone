...
- Name: visual.spec.ts >> equities/chart-panned__terminal3d-dark
...
Locator: getByTestId('scenario-root')
  34828 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-panned.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-panned.png)" with timeout 5000ms
