...
Locator: getByTestId('scenario-root')
  4803 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: terminal3d-light/equities-chart-canvas-spike.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-light/equities-chart-canvas-spike.png)" with timeout 5000ms
