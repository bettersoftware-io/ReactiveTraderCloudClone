...
Locator: getByTestId('scenario-root')
  43822 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-zoomed.png)" with timeout 5000ms
