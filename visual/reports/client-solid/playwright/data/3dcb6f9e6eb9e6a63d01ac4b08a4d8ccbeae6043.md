...
- Name: visual.spec.ts >> equities/chart-compare__terminal-light
- Location: tests/ui/visual/playwright/visual.spec.ts:17:3

# Error details

```
Error: A snapshot doesn't exist at /__w/ReactiveTraderCloudClone/ReactiveTraderCloudClone/packages/ui-contract/goldens/playwright/__screenshots__/react/visual.spec.ts/terminal-light/equities-chart-compare.png.
```
...
- generic [ref=e5]:
  - application "Price chart" [ref=e6]:
    - generic [ref=e12]: +20.00%
    - generic [ref=e13]: +15.00%
    - generic [ref=e14]: +10.00%
    - generic [ref=e15]: +5.00%
    - generic [ref=e16]: 0.00%
    - img [ref=e137]
  - generic [ref=e200]:
    - generic [ref=e201]: 04:00
    - generic [ref=e202]: 04:15
    - generic [ref=e203]: 04:30
    - generic [ref=e204]: 04:45
  - group "Chart navigator" [ref=e205]:
    - img [ref=e206]
```
