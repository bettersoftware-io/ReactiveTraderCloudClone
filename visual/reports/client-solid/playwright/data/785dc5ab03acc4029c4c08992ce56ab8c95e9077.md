...
Locator: getByTestId('scenario-root')
  28809 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal-dark/equities-chart-line.png

Call log:
  - Expect "toHaveScreenshot(terminal-dark/equities-chart-line.png)" with timeout 5000ms
