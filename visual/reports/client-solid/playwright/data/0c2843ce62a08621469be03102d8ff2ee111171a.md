...
Locator: getByTestId('scenario-root')
  42969 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: terminal3d-dark/equities-chart-zoomed.png

Call log:
  - Expect "toHaveScreenshot(terminal3d-dark/equities-chart-zoomed.png)" with timeout 5000ms
