...
- Name: visual.spec.ts >> equities/chart-indicators__holo-light
...
Locator: getByTestId('scenario-root')
  34216 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: holo-light/equities-chart-indicators.png

Call log:
  - Expect "toHaveScreenshot(holo-light/equities-chart-indicators.png)" with timeout 5000ms
