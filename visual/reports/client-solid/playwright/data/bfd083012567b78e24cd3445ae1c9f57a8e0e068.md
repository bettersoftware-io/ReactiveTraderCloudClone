...
Locator: getByTestId('scenario-root')
  29887 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: terminal-light/equities-chart-area.png

Call log:
  - Expect "toHaveScreenshot(terminal-light/equities-chart-area.png)" with timeout 5000ms
