...
```bash
git add packages/core-contract
git commit -m "test(core-contract): slice 3 suites — rfqs, dealers, instruments, rfqQuote, rfqTile, rfqSubmission, ticketSubmission, rfqCountdown; port discipline +3; PENDING_SUITES 44→37" -- packages/core-contract
```
