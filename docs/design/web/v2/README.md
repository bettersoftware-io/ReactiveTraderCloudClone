...
modes), an animated boot sequence, a dockview-style panel layout, event-driven motion
(glides / flashes), and an added Equities module + Admin observability dashboard.
...
This folder contains two things (plus `CHANGELOG.md` listing what changed since v1):
