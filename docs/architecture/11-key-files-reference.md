...
| **Architectural Gates** | `tests/scripts/grep-gates.ts` | CI import-boundary enforcement (grep-based; 33 active gates, numbered to 37 — gates 12–14 retired with Cypress, gate 24 retired with the quickpickle presenter peer (2026-07-20)) |
