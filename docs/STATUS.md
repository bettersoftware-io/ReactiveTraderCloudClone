...
- **SolidJS port** — Phase 5 remaining (e2e + CI symmetry + docs). Phase 4 shipped PR #230: all three visual tiers assert-only vs client-react's golden trees (3,756 screenshots green) + the power-saver UI ported (shell/power specs un-excluded, 84 spec files). Phase 3 shipped PR #216: full contract parity. Plan: [superpowers/plans/2026-07-12-solidjs-port.md](superpowers/plans/2026-07-12-solidjs-port.md)
