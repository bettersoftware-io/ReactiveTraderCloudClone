...
// module is the single import surface both surviving tiers route through
// (vitest-browser's spec and the plain-Playwright host both import
// VisualScenario via "@ui-visual" → react/index.ts → here), so freezing the
