...
test("tile/eurusd-down", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("eurusd-down.png", {
    animations: "disabled",
  });
});
...
test("tile/eurusd-flat", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("eurusd-flat.png", {
    animations: "disabled",
  });
});
...
test("tile/chart-down", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("chart-down.png", {
    animations: "disabled",
  });
});
...
test("tile/chart-empty", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("chart-empty.png", {
    animations: "disabled",
  });
});
...
test("tile/chart-flat", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("chart-flat.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-started", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("execution-started.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-too-long", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("execution-too-long.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-timeout", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("execution-timeout.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-done", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("execution-done.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-rejected", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("execution-rejected.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-credit-exceeded", async ({ mount }) => {
  const c = await mount(
    <VisualScenario name="tile/execution-credit-exceeded" />,
  );
  await expect(c).toHaveScreenshot("execution-credit-exceeded.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-finished-timeout", async ({ mount }) => {
  const c = await mount(
    <VisualScenario name="tile/execution-finished-timeout" />,
  );
  await expect(c).toHaveScreenshot("execution-finished-timeout.png", {
    animations: "disabled",
  });
});
...
test("tile/execution-done-sell", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("execution-done-sell.png", {
    animations: "disabled",
  });
});
...
test("tile/notional-error", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("notional-error.png", {
    animations: "disabled",
  });
});
...
test("tile/rfq-requested", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("rfq-requested.png", {
    animations: "disabled",
  });
});
...
test("tile/rfq-received", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("rfq-received.png", {
    animations: "disabled",
  });
});
...
test("tile/rfq-received-low", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("rfq-received-low.png", {
    animations: "disabled",
  });
});
...
test("tile/rfq-rejected", async ({ mount }) => {
  ...
  await expect(c).toHaveScreenshot("rfq-rejected.png", {
    animations: "disabled",
  });
});
