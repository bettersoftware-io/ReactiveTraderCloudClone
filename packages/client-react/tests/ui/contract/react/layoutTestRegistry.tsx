 ...
 * Dockview bridge, Task 4) — both must exercise identical panel content so
 * their respective contract specs' assertions are comparable. Kept in its
 * own module (not exported alongside a component) because
 * `lint/style/useComponentExportOnlyModules` forbids a non-component export
 * from a file that also exports a component. */
