...
export interface Scenario {
  ...
  /** Raise this scenario's ABSOLUTE pixel allowance above the config-level
   *  `maxDiffPixels` cap (the ratio budget still applies — Playwright takes
   *  the minimum of the two). Reserve for a MEASURED, mechanism-understood
