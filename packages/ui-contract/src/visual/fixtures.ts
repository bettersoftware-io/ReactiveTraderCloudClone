...
// Exported so the equities/chart-canvas composite visual scenario builds its
// ChartScene from the SAME seeded series the equities-loaded fixture
// renders, rather than inventing a second candle set.
