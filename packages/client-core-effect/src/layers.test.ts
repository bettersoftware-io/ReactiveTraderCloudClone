...
describe("buildAppLayer", () => {
  it("resolves every native presenter in ONE synchronous runSync, and builds PowerSaverLive exactly ONCE for both the record and its two dependents", () => {
    ...
    const runtime = ManagedRuntime.make(
      buildAppLayer(createPorts(counted.preferences)),
    );
