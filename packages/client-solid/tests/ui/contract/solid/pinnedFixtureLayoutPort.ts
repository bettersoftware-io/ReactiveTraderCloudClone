 ...
 *
 * Verbatim port of the react driver's fixture (tests/ui/contract/react/
 * pinnedFixtureLayoutPort.ts) — plain TS, no framework dependency, so nothing
 * changes for the Solid driver. */
