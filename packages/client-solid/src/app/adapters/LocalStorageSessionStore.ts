...
// Not exported (client-react exports its copy for the shared e2e seed helper;
// client-solid's e2e reuses that same key, so this copy keeps it internal).
const SESSION_STORAGE_KEY = "rtc-session";
