...
test("the four scenes still deferred resolve to nothing, without throwing", () => {
  // `layers` lands later in 6b-2a; `geo`/`jarvis`/`topo` in 6b-2b.
  for (const variant of ["geo", "layers", "jarvis", "topo"] as const) {
