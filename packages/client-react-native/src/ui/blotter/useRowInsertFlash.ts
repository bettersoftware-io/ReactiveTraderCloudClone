 ...
 * ~30% alpha, down to ~18% at the 35% mark, then transparent — all over
 * 950ms with `cubic-bezier(0.2, 0.8, 0.3, 1)` (`dc.html` L861-881). */
 ...
 * opacity, transparent background — and cancels any running animation. */
